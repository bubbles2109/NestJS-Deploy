...
let AuthController = class AuthController {
    ...
    async login(authDto) {
        try {
            ...
            if (login) {
                return new globalClass_1.ResponseData(globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS, login);
            }
            else {
                return new globalClass_1.ResponseData(globalEnum_1.HttpStatus.UNAUTHORIZED, globalEnum_1.HttpMessage.UNAUTHORIZED, null);
            }
        }
        catch (error) {
            console.log(error);
